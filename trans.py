...
for file in ["valid", "test"]:
    for i in range(20):
        ...
        #     j, j, j, j)
        cmd = "CUDA_VISIBLE_DEVICES=2 python3 translate.py -gpu 0 -model ./checkpoint/freq_2gen_step_40000.pt -output ./data/t_resp/{}{:.1f}.txt -beam 1 -batch_size 2048 -src ./data/t_resp/src-{}.txt -pos_src ./data/freq0.001/pos-src-{}.txt -max_length 30 -learned_t {:.1f}".format(
            file, j, file, file, j)
        print(cmd)
        os.system(cmd)
        print(i, "over")
